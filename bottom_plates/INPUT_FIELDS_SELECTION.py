...
IMPRE_CATHODIC_PROTECTION = [
    ...
    ('All readings around periphery < 0.6 V or none installed - Score=2',
     'All readings around periphery < 0.6 V or none installed')
]
SACRIFICIAL_CATHODIC_PROPECTION = [
    ...
    ('Sacrificial CP not available and not operating - Score=2',
     'Sacrificial CP not available and not operating')
]
...
STORAGE_CONDITIONS = [
    ...
    (f'40{DEGREE_SIGN}C Temperature of product < 85{DEGREE_SIGN}C - Score=1',
     f'40{DEGREE_SIGN}C Temperature of product < 85{DEGREE_SIGN}C'),
...
FOUNDATION_TYPE = [
    ...
    ('Sand pad with annular ring of coarse granular material + sound sand-bitumen top layer - Score=2/3',
     'Sand pad with annular ring of coarse granular material + sound sand-bitumen top layer'),
    ('Sand pad with annular ring of coarse granular material - Score=4/3',
     'Sand pad with annular ring of coarse granular material'),
    ('Traditional granular soil/sand type - Score=2',
     'Traditional granular soil/sand type')
]
HEIGHT_OF_FOUNDATION = [
    ('Tank bottom free from contact with water - Score=0',
     'Tank bottom free from contact with water'),
    ('Tank bottom in contact with water - Score=2',
...
TIME_TO_REPAIR = [
    ...
    ('Internal entry required, major repair (<3 months) - Score=2',
     'Internal entry required, major repair (<3 months)'),
    ('Internal entry required, major repair (3-8 months)- Score=3',
     'Internal entry required, major repair (3-8 months)'),
    ('Internal entry required, limited repair (>8 months)- Score=4',
     'Internal entry required, limited repair (>8 months)')
]
COST_OF_REPAIR = [
...
ENVIRONMETAL_HAZARD_TO_SOIL_AND_WATER_AS_THE_POTENTIAL_TO_CAUSE = [
    ('Nor or negligle environment effect - Score=1',
     'Nor or negligle environment effect'),
    ...
    ('Severe demage/nuisance/pollution over large area- Score=4',
     'Severe demage/nuisance/pollution over large area')
]
VAPOUR_EMISSION = [
    ('No or negligle harmful (toxic) release - Score=1',
     'No or negligle harmful (toxic) release'),
